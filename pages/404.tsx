...
const FourOuFour: NextPage = () => {
    ...
    return(
        <>
            ...
            <main className={` w-full flex flex-col justify-center items-center flex-1 p-3 transition-colors ${ isDarkMode ? 'bg-neutral-700' : 'bg-slate-100' } `}>
                <div className='max-w-3xl flex flex-col items-center gap-y-6'>
                    ...
                    <Link href='/'>
                        ...
                        >
                            <Paragraph text='Back to home page' customCss='text-xl text-blue-500 hover:text-blue-700 focus:text-blue-700 transition-colors' />
                        </button>
                    </Link>
                </div>
            </main>
